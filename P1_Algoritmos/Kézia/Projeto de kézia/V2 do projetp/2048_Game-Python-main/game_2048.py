...
class Game2048(Interface):
    ...
    def put_name(self) -> None:
        ...
        pg.draw.retangulo(self.screen, color := inactive_colour, input_box, 1, border_radius=15)
        pg.display.update()
        ...
        while not input_name:
            ...
            pg.draw.retangulo(self.screen, color, input_box, 1, border_radius=15)
    ...
    def around_arrow(self):
        ...
        pg.draw.retangulo(self.screen, (110, 110, 110), cancel_box, border_radius=12)
        self.screen.blit(font_H3.render('Cancel', True, config.COLORS['WHITE']), (174, 413))

        pg.draw.retangulo(self.screen, (110, 110, 110), repeat_box, border_radius=12)
